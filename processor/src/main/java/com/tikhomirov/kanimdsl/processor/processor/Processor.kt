...
class Processor : AbstractProcessor() {
    ...
    val VIEW_CLASS_NAME = ClassName("android.view", "View")
    val ANIMATOR_CLASS_NAME = ClassName("android.animation", "Animator")
    val ANIMATION_BUILDER_CLASS_NAME = ClassName("com.tikhomirov.kanimdsl", "AnimationBuilder")
